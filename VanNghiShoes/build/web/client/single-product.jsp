                ...
                <div class="row s_product_inner">
                    <div class="col-lg-6">
                        <div class="s_Product_carousel">
                            <div class="single-prd-item">
                                <img class="img-fluid" src="${item.product.img1}" alt="">
                            </div>
                            <div class="single-prd-item">
                                <img class="img-fluid" src="${item.product.img2}" alt="">
                            </div>
                            <div class="single-prd-item">
                                <img class="img-fluid" src="${item.product.img3}" alt="">
                            </div>
                            <div class="single-prd-item">
                                <img class="img-fluid" src="${item.product.img4}" alt="">
                            </div>
                            <div class="single-prd-item">
                                <img class="img-fluid" src="${item.product.img5}" alt="">
                            </div>
                            <div class="single-prd-item">
                                <img class="img-fluid" src="${item.product.img6}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 offset-lg-1">
                        <div class="s_product_text">
                            ...
                            <h2>${item.product.listedPrice} VND</h2>
                            <ul class="list">
                                <li><a class="active" href="#"><span>Brand</span> : ${item.category.name}</a></li>
                                <li>
                                    <a>
                                        <%int index = 0;%>
                                        <span>Size</span> : 
                                        <c:forEach var="i" items="${item.productSizeDTOs}">
                                            <c:if test="${i.quantity > 0}">
                                                <input class="pixel-radio size" onclick="checkOption(${i.quantity})" type="radio" name="size" value="${i.sizeId}">
                                                <label>${i.size}</label>
                                                <%++index;%>
                                            </c:if>
                                        </c:forEach>
                            ...
                            <div class="product_count" id="qty" style="display: none">
                                <label for="qty">Quantity:</label>
                                <input onkeyup="checkQuantity()" required type="number" name="qty" id="sst" min="1" max="${i.quantity}" value="1" title="Quantity:" class="input-text qty">
                            </div>
                            <p>${item.product.description}</p>
                            <div class="card_area d-flex align-items-center">
                                <button id="addCart" disabled style="cursor: not-allowed" class="primary-btn" onclick="selectItem('${item.product.id}', sizeId)">Add to Cart</button>
                            ...
                            <div class="col-lg-6">
                                <div class="comment_list">
                                    ...
                                    <div class="review_item reply">
                                        <div class="media">
                                            <div class="d-flex">
                                                <img src="<%=request.getContextPath()%>/client/img/product/review-2.png" alt="">
                                            </div>
                                            <div class="media-body">
                                                <h4>Blake Ruiz</h4>
                                                <h5>12th Feb, 2018 at 05:56 pm</h5>
                                    ...
                                    <div class="review_item">
                                        <div class="media">
                                            <div class="d-flex">
                                                <img src="<%=request.getContextPath()%>/client/img/product/review-3.png" alt="">
                                            </div>
                                            <div class="media-body">
                                                <h4>Blake Ruiz</h4>
                                                <h5>12th Feb, 2018 at 05:56 pm</h5>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="review_list">
                                    <div class="review_item">
                                        <div class="media">
                                            <div class="d-flex">
                                                <img src="<%=request.getContextPath()%>/client/img/product/review-1.png" alt="">
                                            </div>
                                            <div class="media-body">
                                                <h4>Blake Ruiz</h4>
