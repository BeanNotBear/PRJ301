...
<html lang="zxx" class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="<%=request.getContextPath()%>/client/css/ion.rangeSlider.css" />
        <link rel="stylesheet" href="<%=request.getContextPath()%>/client/css/ion.rangeSlider.skinFlat.css" />
        <link rel="stylesheet" href="<%=request.getContextPath()%>/client/css/magnific-popup.css">
                            ...
                            <div class="row single-slide align-items-center d-flex">
                                ...
                                <div class="col-lg-7">
                                    <div class="banner-img">
                                        <img class="img-fluid" src="<%=request.getContextPath()%>/client/img/banner/banner-img.png" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- single-slide -->
                ...
                <div class="row features-inner">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-features">
                            <div class="f-icon">
                                <img src="<%=request.getContextPath()%>/client/img/features/f-icon1.png" alt="">
                            </div>
                            <h6>Free Delivery</h6>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-features">
                            <div class="f-icon">
                                <img src="<%=request.getContextPath()%>/client/img/features/f-icon2.png" alt="">
                            </div>
                            <h6>Return Policy</h6>
                            <p>Free Shipping on all order</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-features">
                            <div class="f-icon">
                                <img src="<%=request.getContextPath()%>/client/img/features/f-icon3.png" alt="">
                            </div>
                            <h6>24/7 Support</h6>
                            <p>Free Shipping on all order</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-features">
                            <div class="f-icon">
                                <img src="<%=request.getContextPath()%>/client/img/features/f-icon4.png" alt="">
                            </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8">
                                <div class="single-deal">
                                    ...
                                    <img class="img-fluid w-100" src="<%=request.getContextPath()%>/client/img/category/c1.jpg" alt="">
                                    <a href="<%=request.getContextPath()%>/client/img/category/c1.jpg" class="img-pop-up" target="_blank">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="single-deal">
                                    <div class="overlay"></div>
                                    <img class="img-fluid w-100" src="<%=request.getContextPath()%>/client/img/category/c2.jpg" alt="">
                                    <a href="<%=request.getContextPath()%>/client/img/category/c2.jpg" class="img-pop-up" target="_blank">
                                        <div class="deal-details">
                                            <h6 class="deal-title">Sneaker for Sports</h6>
                                        </div>
                                    </a>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="single-deal">
                                    <div class="overlay"></div>
                                    <img class="img-fluid w-100" src="<%=request.getContextPath()%>/client/img/category/c3.jpg" alt="">
                                    <a href="<%=request.getContextPath()%>/client/img/category/c3.jpg" class="img-pop-up" target="_blank">
                                        <div class="deal-details">
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="single-deal">
                                    <div class="overlay"></div>
                                    <img class="img-fluid w-100" src="<%=request.getContextPath()%>/client/img/category/c4.jpg" alt="">
                                    <a href="<%=request.getContextPath()%>/client/img/category/c4.jpg" class="img-pop-up" target="_blank">
                                        <div class="deal-details">
                                            <h6 class="deal-title">Sneaker for Sports</h6>
                                        </div>
                                    </a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="<%=request.getContextPath()%>/client/img/category/c5.jpg" alt="">
                            <a href="<%=request.getContextPath()%>/client/img/category/c5.jpg" class="img-pop-up" target="_blank">
                                <div class="deal-details">
                                    <h6 class="deal-title">Sneaker for Sports</h6>
                                </div>
                            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="<%=request.getContextPath()%>/client/img/product/p1.jpg" alt="">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="<%=request.getContextPath()%>/client/img/product/p2.jpg" alt="">
                                <div class="product-details">
                                    <h6>addidas New Hammer sole
                                        for Sports person</h6>
                                    <div class="price">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="<%=request.getContextPath()%>/client/img/product/p3.jpg" alt="">
                                <div class="product-details">
                                    <h6>addidas New Hammer sole
                                        for Sports person</h6>
                                    <div class="price">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="<%=request.getContextPath()%>/client/img/product/p4.jpg" alt="">
                                <div class="product-details">
                                    <h6>addidas New Hammer sole
                                        for Sports person</h6>
                                    <div class="price">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="<%=request.getContextPath()%>/client/img/product/p5.jpg" alt="">
                                <div class="product-details">
                                    <h6>addidas New Hammer sole
                                        for Sports person</h6>
                                    <div class="price">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="<%=request.getContextPath()%>/client/img/product/p6.jpg" alt="">
                                <div class="product-details">
                                    <h6>addidas New Hammer sole
                                        for Sports person</h6>
                                    <div class="price">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="<%=request.getContextPath()%>/client/img/product/p7.jpg" alt="">
                                <div class="product-details">
                                    <h6>addidas New Hammer sole
                                        for Sports person</h6>
                                    <div class="price">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="<%=request.getContextPath()%>/client/img/product/p8.jpg" alt="">
                                <div class="product-details">
                                    <h6>addidas New Hammer sole
                                        for Sports person</h6>
                                    <div class="price">
                    ...
                    <div class="col-lg-6 no-padding exclusive-right">
                        <div class="active-exclusive-product-slider">
                            ...
                            <div class="single-exclusive-slider">
                                <img class="img-fluid" src="<%=request.getContextPath()%>/client/img/product/e-p1.png" alt="">
                                <div class="product-details">
                                    <div class="price">
                                        <h6>$150.00</h6>
                                        <h6 class="l-through">$210.00</h6>
            ...
            <div class="container">
                <div class="row">
                    <a class="col single-img" href="#">
                        <img class="img-fluid d-block mx-auto" src="<%=request.getContextPath()%>/client/img/brand/1.png" alt="">
                    </a>
                    <a class="col single-img" href="#">
                        <img class="img-fluid d-block mx-auto" src="<%=request.getContextPath()%>/client/img/brand/2.png" alt="">
                    </a>
                    <a class="col single-img" href="#">
                        <img class="img-fluid d-block mx-auto" src="<%=request.getContextPath()%>/client/img/brand/3.png" alt="">
                    </a>
                    <a class="col single-img" href="#">
                        <img class="img-fluid d-block mx-auto" src="<%=request.getContextPath()%>/client/img/brand/4.png" alt="">
                    </a>
                    <a class="col single-img" href="#">
                        <img class="img-fluid d-block mx-auto" src="<%=request.getContextPath()%>/client/img/brand/5.png" alt="">
                    </a>
                </div>
            </div>
        </section>
